...
public class GetTripsNumWithMaximumStopsProcessorTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		processor = new GetTripsNumWithMaximumStopsProcessor(uiCenterInstance);
		uiCenterInstance.register(GetTripsNumWithMaximumStopsProcessor.KEY, processor);
	}
	...
	public static void tearDownBeforeClass() throws Exception {
		processor = null;
		stringBufferUI = null;
		uiCenterInstance.unregister(GetTripsNumWithMaximumStopsProcessor.KEY);
	}
	...
	public void testProcess2() {
		...
		String validKey = GetTripsNumWithMaximumStopsProcessor.KEY;
